    ...
    return (
        ...
        <>
            <nav className='z-50 relative flex bg-zinc-800 text-white px-8 py-4 items-center justify-between'>
                ...
                <div className='nav-linls-bookheaven block md:flex items-center gap-4'>
            ...
            <div className='bg-zinc-800 h-screen absolute top-0 left-0 w-full z-40 flex flex-col items-center justify-center '>
                {links.map((items, i) => (
                    <Link to={items.link}
                        className=' text-white text-4xl mb-8 font-semibold  hover:text-blue-500 transition-all duration-300' key={i}>{items.title}
                    </Link>))}

                {/* side bar login and singup  */}


                <Link to="/SignUp"
                    className='px-4 mb-8 text-3xl font-semibold py-2 border border-blue-500 text-white hover:bg-white hover:text-zinc-800 transition-all duration-300'>SignUp</Link>


                <Link to="/LogIn"
                    className='px-4  text-3xl font-semibold mb-8 py-2  bg-blue-500 rounded  text-white hover:bg-white hover:text-zinc-800 transition-all duration-300'>LogIn</Link>
